...
param kubeManifest string = ''

var useExistingManagedIdentity = newOrExistingManagedIdentity == 'existing'

@description('CertManager Managed Identity to be used for cluster issuer')
param aksManagedId string
...
resource runAksCommand 'Microsoft.Resources/deploymentScripts@2023-08-01' = {
  ...
  properties: {
    ...
    environmentVariables: [
      ...
      { name: 'aksManagedId', value: aksManagedId}
      { name: 'kubeManifest', value: kubeManifest}
    ]

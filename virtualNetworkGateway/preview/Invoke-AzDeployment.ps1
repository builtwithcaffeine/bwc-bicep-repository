...
# Check for Azure VPN Enterprise Application
...
if ($deploy) {
    ...
    $microsoftDocs = "`e]8;;https://learn.microsoft.com/en-us/azure/vpn-gateway/openvpn-azure-ad-tenant#enable-authentication`e\Configure Point to Site`e]8;;`e\"
    Write-Output `r "Azure Point to Site Configuration Detials."
    Write-Output "Microsoft Docs Page: $microsoftDocs" `r
    Write-Output "TenantId: https://login.microsoftonline.com/$tenantId"
    Write-Output "Audience - [Azure Public]: 41b23e61-6c1e-4545-b367-cd054e0ed4b4"
    Write-Output "Issuer - https://sts.windows.net/$tenantId/"
}
